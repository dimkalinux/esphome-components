...
namespace esphome
{
    namespace udp_failover
    {
        ...
        void UdpFailoverComponent::receive_packets_()
        {
            ...
            // echoing each other indefinitely; a holding peer repeats its hello
            // every REPLY_MIN_GAP_MS, so one skipped by the guard gets the next.
